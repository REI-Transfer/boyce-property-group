...
export async function POST(request: Request) {
  try {
    ...
    try {
      const GF_CREDENTIAL_ID = process.env.GOFUNNEL_WEBHOOK_CREDENTIAL_ID || "12dc64a4-ae18-41a1-9ce3-15bad253e197"
      const GF_BEARER = process.env.GOFUNNEL_WEBHOOK_SECRET || "301c4690-6e7a-41c1-9546-99a00769dc38"
      if (GF_CREDENTIAL_ID && GF_BEARER) {
        ...
        const gfPayload = {
          ...
          sid: gfSid || undefined,
          formId: "boyce-property-group-survey",
          formTitle: "Boyce Property Group Survey",
